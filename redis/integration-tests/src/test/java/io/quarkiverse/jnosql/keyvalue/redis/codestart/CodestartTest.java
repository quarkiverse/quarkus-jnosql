package io.quarkiverse.jnosql.keyvalue.redis.codestart;
...
public class CodestartTest {
    ...
    public static final String CODESTART_ARTIFACT = "io.quarkiverse.jnosql:quarkus-jnosql-redis";
    @RegisterExtension
    ...
    void testContent() throws Throwable {
        ...
        codestartTest.checkGeneratedTestSource("org.acme.RedisTestResource");
    }
