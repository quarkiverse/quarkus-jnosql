...
@Singleton
public class QuarkusValkeyBucketManagerFactoryProducer implements Supplier<BucketManagerFactory> {

    @Inject
    protected QuarkusValkeyKeyValueConfiguration configuration;
