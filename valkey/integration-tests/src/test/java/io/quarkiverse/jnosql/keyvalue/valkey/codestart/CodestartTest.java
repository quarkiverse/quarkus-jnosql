package io.quarkiverse.jnosql.keyvalue.valkey.codestart;
...
public class CodestartTest {
    ...
    public static final String CODESTART_ARTIFACT = "io.quarkiverse.jnosql:quarkus-jnosql-valkey";
    @RegisterExtension
    ...
    void testContent() throws Throwable {
        ...
        codestartTest.checkGeneratedTestSource("org.acme.ValkeyTestResource");
    }
