...
https://redis.io/[Redis] is an open source, in-memory data structure store used as a database, cache, and message broker. Since https://valkey.io/[Valkey] is wire-compatible with Redis, this extension works with Valkey as well.
