...
The Quarkus JNoSQL Extensions are using the annotation processor provided by the `org.eclipse.jnosql.lite:mapping-lite-processor` dependency. This dependency is automatically included when you add any Quarkus JNoSQL extension to your project.
