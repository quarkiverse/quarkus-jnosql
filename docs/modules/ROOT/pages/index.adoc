...
<properties>
    ...
    <jnosql-lite-processor.version>1.1.15</jnosql-lite-processor.version>
...
Replace `1.1.15` with the latest available version from Maven Central when configuring your project.
