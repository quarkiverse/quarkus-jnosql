package io.quarkiverse.jnosql.oracle.codestart;
...
public class CodestartTest {
    ...
    public static final String CODESTART_ARTIFACT = "io.quarkiverse.jnosql:quarkus-jnosql-oracle-nosql";
    @RegisterExtension
    ...
    void testContent() throws Throwable {
        ...
        codestartTest.checkGeneratedTestSource("org.acme.OracleNoSQLTestResource");
